...
def calc_omega(thickness, gate_voltage, tol=2e-3):
    ...
    layer_list.append(Layer(12, 0, 0, name='screening_quantum_well'))
    ...
    # layer_list.append(Layer(10, 0, 0, name='screening_quantum_well'))
    layer_list.append(Layer(5, 0.36, 0.0, name='spacer'))
    # layer_list.append(Layer(2, 0.36, 5e17, name='n-type'))
    ...
    res, loss = schpois.self_consistent_minimize(num_iter=20, tol=tol)
